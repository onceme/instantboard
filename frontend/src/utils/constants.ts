...
export const SSO_PROVIDERS = [
  { name: 'Google', slug: 'google', brand_color: '#4285F4', icon: 'google-icon' },
  { name: 'Azure AD', slug: 'azure_ad', brand_color: '#0078D4', icon: 'azure-icon' },
  { name: 'GitHub', slug: 'github', brand_color: '#333333', icon: 'github-icon' },
  { name: 'Apple', slug: 'apple', brand_color: '#000000', icon: 'apple-icon' },
  { name: 'Facebook', slug: 'facebook', brand_color: '#1877F2', icon: 'facebook-icon' },
]
